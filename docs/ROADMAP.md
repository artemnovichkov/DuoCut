...
- [x] Fallback-ввод: свайп поперёк линии реза режет так же — игра остаётся играбельной на обычном iPhone. (Написано; проверить на не-складном симуляторе в Фазе 7.)
