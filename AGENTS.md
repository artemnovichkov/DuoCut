...
display; add `--display=1` for the outer one. Only the active display has content. Use
[hinge](https://github.com/artemnovichkov/hinge) to fold, half-open, or unfold the simulator and to
read the angle.
